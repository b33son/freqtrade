...
class Strategy004(IStrategy):
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append((
            ...
            (dataframe['slowfastd-previous'] <
             self.buy_slowfastk_slowfastd.value)
        ))
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append((dataframe['fastk'] > self.sell_fastk_fastd.value) | (
            dataframe['fastd'] > self.sell_fastk_fastd.value))
