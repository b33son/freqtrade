...
# -s = strategy
# -i = interval
#   dcr freqtrade backtesting --datadir user_data/data/binance --export trades --stake-amount 100 -s Strategy004 -i 5m
# Plot Strategy
#   1) Switch build from stable to plot in docker-compose.yml by uncommenting plot
#   2) dcr freqtrade plot-dataframe --strategy Strategy004 -p ETH/USDT -i 5m
# Download Data
